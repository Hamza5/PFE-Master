...
\usepackage[hidelinks,
            urlcolor=blue,
            unicode=true,
            pdftitle={Estimation de distances à partir d'images},
...
\usepackage[onelanguage,french,longend,boxruled,algoruled,linesnumbered,algochapter]{algorithm2e}
\usepackage{listings}
...
% Paramètres du code
\lstset{numbers=left,frame=single,breaklines,basicstyle=\ttfamily\footnotesize}
