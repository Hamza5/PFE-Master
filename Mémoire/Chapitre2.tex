...
\caption{L'architecture globale du champ de neurones convolutionel}{\cite{liu2015deep}}
\end{figure}
...
profondeurs générées à partir des scanners laser ou infrarouge (comme SICK et Microsoft Kinect)
