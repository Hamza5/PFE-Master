...
class Ui_CapturesDialog(object):
    def setupUi(self, CapturesDialog):
        ...
        self.captureNumberLabel = QtWidgets.QLabel(self.capturesGroupBox)
    ...
    def retranslateUi(self, CapturesDialog):
        ...
        self.capturesGroupBox.setTitle(_translate("CapturesDialog", "Capture"))
        self.captureNumberLabel.setText(_translate("CapturesDialog", "N°"))
